...
There are 5 classes: batima, botinha, linco, nico, peto.
...
class Model(keras.Model):
    def __init__(self):
        ...
        self.model = keras.Sequential(
            [
                keras.layers.Conv2D(
                    64, (3, 3), activation="relu", input_shape=(40, 30, 3)
                ),
    ...
    def plot(self, filename="model.png"):
        keras.utils.plot_model(
            self, to_file=filename, show_shapes=True, show_layer_names=True
        )
